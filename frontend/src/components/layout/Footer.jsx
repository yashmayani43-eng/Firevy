            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-[16px] p-5 border border-slate-200/90 shadow-sm space-y-3 min-h-[145px] flex flex-col justify-between">
                ...
                <div className="space-y-2 text-[12.5px] text-slate-700 font-sans">
                  ...
                  <a
                    href={`tel:${(footerConfig?.salesContact?.phoneIndia && !footerConfig?.salesContact?.phoneIndia.includes('942-970-9662') ? footerConfig?.salesContact?.phoneIndia : '+91 7069370629').replace(/[^0-9+]/g, '')}`}
                    className="flex items-center space-x-2 hover:text-[#006B8F] transition-colors"
                  >
                    <Phone className="w-4 h-4 text-[#0080B0] shrink-0" />
                    <span className="font-[600]">
                      {footerConfig?.salesContact?.phoneIndia && !footerConfig?.salesContact?.phoneIndia.includes('942-970-9662') ? footerConfig?.salesContact?.phoneIndia : 'IN: +91 7069370629'}
                    </span>
                  </a>
                </div>
              </div>
