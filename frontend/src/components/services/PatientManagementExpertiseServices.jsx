...
const expertiseCards = [
  {
    ...
    desc: 'Full-scale enterprise hospital management unifying bed allocation, ward administration, outpatient queues, operation theaters, and doctor rosters.'
  },
  {
    title: 'Electronic Health Records (EHR/EMR)',
    desc: 'HIPAA-compliant digital medical charting, patient clinical histories, diagnostic lab uploads, allergy alerts, and seamless HL7/FHIR integrations.'
  },
  {
    title: 'Clinic & Specialty Practice Software',
    desc: 'Tailored practice management for dental clinics, ophthalmology, cardiology, and pediatrics with customized treatment planners and charting.'
  },
  {
    title: 'Pharmacy & Medication Dispensing Systems',
    desc: 'Real-time drug inventory management, digital prescription fulfillment, barcode verification, expiry tracking, and automated re-ordering.'
  },
  {
    title: 'Laboratory Information Systems (LIS)',
    desc: 'Sample tracking, pathology lab device integration, automated diagnostic report generation, and instant delivery to doctor and patient portals.'
  },
  {
    title: 'Patient Engagement & Telehealth Portals',
    desc: 'Self-service mobile applications for appointment booking, encrypted teleconsultation, bill payment, prescription downloads, and vital monitoring.'
  }
];

export const PatientManagementExpertiseServices = () => {
...
export default PatientManagementExpertiseServices;
